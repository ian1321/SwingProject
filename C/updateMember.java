			...
			public void mouseClicked(MouseEvent arg0) {
				try {
					if (textField_1.getText().equals("") || textField_2.getText().equals("") || textField_3.getText().equals("") || textField_4.getText().equals("")) {
						JOptionPane.showMessageDialog(null, "모든 항목을 입력해주세요", "알림", 0);
					}
					else if (textField_1.getText().equals(textField_2.getText())) {
						new MemberDAO().update(new MemberDTO(MemberDTO.SessionId, Integer.parseInt(textField_2.getText()),
								textField_3.getText(),textField_4.getText()));
						JOptionPane.showMessageDialog(null, "수정이 완료되었습니다.", "알림", 0);
						new MyPage();
						dispose();
					}
					else  {
						JOptionPane.showMessageDialog(null, "비밀번호가 재입력값과 일치하지 않습니다.", "알림", 0);
					}
				}  catch (Exception e) {
